    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private void ScreenshotButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (this.bodyIndexBitmap != null)
            {
                ...
                string mycustompath = path_;

                string path = Path.Combine(mycustompath, "/bodyIndex" + frameCount.ToString() + ".png");
        ...
        {
            path_ = this.dir_text.Text;
            if (path_ == "") return;
            if (this.min_text.Text != "")
                min_ = Convert.ToInt16(this.min_text.Text);
            else return;
            if (this.max_text.Text != "")
                max_ = Convert.ToInt16(this.max_text.Text);
            else return;
            Console.WriteLine(path_);
            Console.WriteLine(min_.ToString());
            Console.WriteLine(max_.ToString());
            Submit_btn.Visibility = System.Windows.Visibility.Hidden;
